...
#define PM_NUM 6
#define PM_ALL_BY_SIZE "otp settings_storage tfm tfm_sram nonsecure_storage sram_secure tfm_secure rpmsg_nrf53_sram sram_primary sram_nonsecure app tfm_nonsecure"
